<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight bg-">
            {{ __('Home') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12 bg-white">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-blue-700 border-b border-gray-200 text-center text-white">
                    Welcome to the my Personal Portfolio Website!
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="-mx-4 flex flex-wrap bg-white">
        ...
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="mx-auto mb-10 max-w-[370px]">
                <div class="mb-8 overflow-hidden rounded">
                    <img src="https://cdn.tailgrids.com/1.0/assets/images/blogs/blog-01/image-02.jpg" alt="image" class="w-full" />
                </div>
                <div>
                    <h3>
                        <a href="javascript:void(0)" class="text-dark hover:text-primary mb-4 inline-block text-xl font-semibold sm:text-2xl lg:text-xl xl:text-2xl">
        ...
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="mx-auto mb-10 max-w-[370px]">
                <div class="mb-8 overflow-hidden rounded">
                    <img src="https://cdn.tailgrids.com/1.0/assets/images/blogs/blog-01/image-03.jpg" alt="image" class="w-full" />
                </div>
                <div>
                    <h3>
                        <a href="javascript:void(0)" class="text-dark hover:text-primary mb-4 inline-block text-xl font-semibold sm:text-2xl lg:text-xl xl:text-2xl">
                    ...
                    <div class="mb-12 max-w-[570px] lg:mb-0">
                        ...
                        <div class="mb-8 flex w-full max-w-[370px]">
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-body-color text-base">
                                    Kenrock Country Estate, Valley Rd 7806 South Africa
                                </p>
                            </div>
                        </div>
                        <div class="mb-8 flex w-full max-w-[370px]">
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-body-color text-base">(+27)62 457 2904</p>
                            </div>
                        </div>
                        <div class="mb-8 flex w-full max-w-[370px]">
                            <div class="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-body-color text-base">keegan@obox.co.za</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                    <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                        <form>
                            ...
                            <div>
                                <button type="submit" class="bg-primary border-primary w-full rounded border p-3 text-black transition hover:bg-opacity-90">
                                    Send Message
                                </button>
                            </div>
                        </form>
            ...
            <div class="-mx-4 flex flex-wrap">
                ...
                <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                    <div class="mb-10 w-full">
                        ...
                        <ul>
                            <li>
                                <a href="javascript:void(0)" class="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose">
                                    SaaS Development
                                </a>
                            </li>
                            <li>
                ...
                <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
                    <div class="mb-10 w-full">
                        <h4 class="text-dark mb-9 text-lg font-semibold">Follow Me On</h4>
                        <div class="mb-6 flex items-center">
                            <a href="https://www.linkedin.com/in/keegan-kelly-6944ba203/" class="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                        ...
                        <p class="text-body-color text-base">&copy; 2022 Keegan Kelly</p>
                    </div>
                </div>
            </div>
        </div>
